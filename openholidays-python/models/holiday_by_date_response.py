...
class HolidayByDateResponse(BaseModel):
    ...
    type: HolidayType
    __properties: ClassVar[List[str]] = ["comment", "country", "groups", "id", "name", "nationwide", "regionalScope", "subdivisions", "tags", "temporalScope", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "country": CountryReference.from_dict(obj["country"]) if obj.get("country") is not None else None,
