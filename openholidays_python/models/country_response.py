...
class CountryResponse(BaseModel):
    ...
    """ # noqa: E501
    iso_code: Annotated[str, Field(min_length=1, strict=True)] = Field(description="ISO 3166-1 country code", alias="isoCode")
    name: List[LocalizedText] = Field(description="Localized country names")
    official_languages: List[StrictStr] = Field(description="Official ISO-639-1 language codes", alias="officialLanguages")
    __properties: ClassVar[List[str]] = ["isoCode", "name", "officialLanguages"]
